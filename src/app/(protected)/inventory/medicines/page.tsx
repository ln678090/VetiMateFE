                  ...
                  >
                    <div className="col-span-1 md:col-span-5 flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg bg-m3-surface-container flex items-center justify-center shrink-0 border border-m3-outline-variant/30">
                        {item.unit.toLowerCase().includes('viên') ||
                        item.unit.toLowerCase().includes('hộp') ? (
                      ...
                      <div>
                        ...
                        <p className="font-body-sm text-[12px] text-m3-on-surface-variant">
                          Mã: {item.id.slice(0, 8)}
                        </p>
                      </div>
                    </div>

                    <div className="col-span-1 md:col-span-3 flex items-center gap-1.5">
                      <span className="font-body-sm text-[14px] text-m3-on-surface">
                        {item.unit}
                      </span>
                    </div>
                    ...
                    <div className="col-span-1 md:col-span-4 flex items-center">
                      <span
                        className={`px-3 py-1 rounded-full text-[12px] font-semibold ${item.isActive ? 'bg-m3-primary-container/20 text-m3-primary' : 'bg-m3-error/10 text-m3-error'}`}
                      >
            ...
            {activeItem ? (
              <div className="bg-m3-surface-container-lowest rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.04)] p-[24px] sticky top-[24px] border border-m3-outline-variant/30">
                ...
                <div className="w-full h-48 bg-m3-surface-container/50 rounded-lg mb-[24px] flex items-center justify-center border border-m3-outline-variant/20">
                  {activeItem.unit.toLowerCase().includes('viên') ||
                  activeItem.unit.toLowerCase().includes('hộp') ? (
                ...
                <div className="flex gap-2 mb-[24px]">
                  ...
                  <span
                    className={`px-2 py-1 rounded-md font-label-sm text-[12px] ${activeItem.isActive ? 'bg-m3-primary-container/20 text-m3-primary' : 'bg-m3-error/10 text-m3-error'}`}
                  >
                ...
                <div className="space-y-3">
                  <div className="flex justify-between py-1.5 border-b border-m3-outline-variant/30">
                    ...
                    <span className="font-label-md text-[14px] font-semibold text-m3-on-surface font-mono">
                  ...
                  <div className="flex justify-between py-1.5 border-b border-m3-outline-variant/30">
                    ...
                    <span className="font-label-md text-[14px] font-semibold text-m3-on-surface">
                      {activeItem.unit}
                    </span>
                  </div>
                </div>
                ...
                <div className="mt-[40px] flex gap-3">
                  <Link
                    ...
                    className="flex-1 bg-m3-primary text-m3-on-primary py-2.5 rounded-lg font-label-md text-[14px] font-semibold hover:bg-m3-surface-tint transition-colors text-center shadow-sm"
                  >
                    Nhập lô mới
                  </Link>
              ...
              <div className="bg-m3-surface-container-lowest rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.04)] p-[24px] sticky top-[24px] border border-m3-outline-variant/30 h-64 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-m3-on-surface-variant text-[14px]">
