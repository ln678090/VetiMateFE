...
export function VoucherForm() {
  ...
  const [sourceWarehouse, setSourceWarehouse] = useState<import('@/types/inventory').WarehouseLocation>('STORAGE');
  const [destinationWarehouse, setDestinationWarehouse] = useState<import('@/types/inventory').WarehouseLocation | ''>('');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const req: CreateVoucherRequest = {
      ...
      destinationWarehouse: (destinationWarehouse as import('@/types/inventory').WarehouseLocation) || undefined,
      note: note || undefined,
                      ...
                      <div className="space-y-[4px]">
                        ...
                        <select
                          ...
                          onChange={(e) => {
                            ...
                            updateItem(idx, { medicineId: val, productId: val ? undefined : undefined });
                          }}
                          className="w-full px-[12px] py-[12px] bg-m3-surface border border-m3-outline-variant rounded-lg font-body-md text-[16px] text-m3-on-surface focus:border-m3-primary focus:ring-2 focus:ring-m3-primary/10 transition-all outline-none"
                        >
