...
export const APP_NAVIGATION_ITEMS: readonly AppNavigationItem[] = [
...

  {
    ...
    href: '/inventory',
    icon: LayoutDashboard,
    accessRoles: [ROLE.ADMIN, ROLE.WAREHOUSE],
    sidebarRoles: [ROLE.WAREHOUSE],
    dashboardRoles: [ROLE.WAREHOUSE],
    dashboardDescription: 'Thống kê tổng quan về kho hàng.',
    gradient: 'from-emerald-500 to-teal-500',
    group: 'Kho',
  },
  {
    ...
    sidebarRoles: [ROLE.WAREHOUSE],
    dashboardRoles: [ROLE.WAREHOUSE],
    dashboardDescription: 'Quản lý tồn kho hiện tại của cửa hàng.',
  ...
  },
  {
    ...
    sidebarRoles: [ROLE.WAREHOUSE],
    dashboardRoles: [ROLE.WAREHOUSE],
    dashboardDescription: 'Quản lý thông tin nhà cung cấp.',
  ...
  },
  {
    ...
    sidebarRoles: [ROLE.WAREHOUSE],
    dashboardRoles: [ROLE.WAREHOUSE],
    dashboardDescription: 'Quản lý danh mục thuốc và vật tư y tế.',
  ...
  },
  {
    ...
    sidebarRoles: [ROLE.WAREHOUSE],
    dashboardRoles: [ROLE.WAREHOUSE],
    dashboardDescription: 'Quản lý các phiếu nhập và xuất kho.',
